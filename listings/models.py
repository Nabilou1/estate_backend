...
class Listing(models.Model):
    ...
    choices_area = (('Inner London', 'Inner London'), ('Outer London', 'Outer London'))
    ...
    choices_listing_type = (('House', 'House'), ('Apartment', 'Apartment'), ('Office', 'Office'))
    listing_type = models.CharField(max_length=20, blank=True, null=True, choices=choices_listing_type) 
    ...
    picture1 = models.ImageField(blank=True, null=True, upload_to="pictures_/%Y/%m/%d/")
    picture2 = models.ImageField(blank=True, null=True, upload_to="pictures_/%Y/%m/%d/")
    picture3 = models.ImageField(blank=True, null=True, upload_to="pictures_/%Y/%m/%d/")
    picture4 = models.ImageField(blank=True, null=True, upload_to="pictures_/%Y/%m/%d/")
    picture5 = models.ImageField(blank=True, null=True, upload_to="pictures_/%Y/%m/%d/")
